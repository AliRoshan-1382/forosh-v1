        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?= asset_url('img/messages-1.jpg') ?>" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?= asset_url('img/messages-2.jpg') ?>" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="<?= asset_url('img/messages-3.jpg') ?>" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Sales</span></h5>
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="<?= asset_url('img/product-1.jpg') ?>" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<?= asset_url('img/product-2.jpg') ?>" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<?= asset_url('img/product-3.jpg') ?>" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<?= asset_url('img/product-4.jpg') ?>" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<?= asset_url('img/product-5.jpg') ?>" alt=""></a></th>
            ...
            <div class="card-body pb-0">
              ...
              <div class="news">
                <div class="post-item clearfix">
                  <img src="<?= asset_url('img/news-1.jpg') ?>" alt="">
                  <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                  <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<?= asset_url('img/news-2.jpg') ?>" alt="">
                  <h4><a href="#">Quidem autem et impedit</a></h4>
                  <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<?= asset_url('img/news-3.jpg') ?>" alt="">
                  <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<?= asset_url('img/news-4.jpg') ?>" alt="">
                  <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                  <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<?= asset_url('img/news-5.jpg') ?>" alt="">
