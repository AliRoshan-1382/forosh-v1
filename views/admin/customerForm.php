    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= site_url('admin/customerForm') ?>" class="active">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= site_url('admin/addCustomer') ?>" method="post">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Customer Username</label>
                  <div class="col-sm-10">
                    <input type="text" name="cusername" id="cpassword" class="form-control" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Customer Password</label>
                  <div class="col-sm-10">
