          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="<?= site_url('customer') ?>" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= site_url('customer/login') ?>" class="row g-3 needs-validation" novalidate method="post">
