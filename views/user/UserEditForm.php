    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-3">
            <div class="container mt-3">
              ...
              <form action="<?= site_url('AdduserEdit') ?>" class="was-validated" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <select  class="form-select" required name="group">
                                <?php foreach ($groups as $group):?>
                                    <?php if ($group['Gname'] == $user['group_name']) { ?>
                        ...
                        <div class="form-floating mb-3 mt-3 ">
                            <select  class="form-select" required name="gender">
                                <?php $gender = ['زن','مرد']; foreach ($gender as $gen):?>
                                    <?php if ($gen == $user['Gender'] ) { ?>
